...
summary: For data that have a high-to-noise ratio, a nonparametric, adaptive method might be appropriate.
---

For data that have a high-to-noise ratio, a nonparametric, adaptive method
...
We now turn our attention to wavelets. (....)
